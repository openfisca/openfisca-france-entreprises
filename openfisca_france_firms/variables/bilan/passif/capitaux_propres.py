...
class capitaux_propres(Variable):
    ...
    def formula(UniteLegale, period):
        ...
        primes_emission_fusion_apport = UniteLegale("primes_emission_fusion_apport", period)
        ecarts_reevaluation = UniteLegale("ecarts_reevaluation", period)
        reserve_legale = UniteLegale("reserve_legale", period)
        reserves_statutaires_contractuelles = UniteLegale("reserves_statutaires_contractuelles", period)
