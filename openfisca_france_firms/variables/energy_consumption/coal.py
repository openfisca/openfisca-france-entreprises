...
class consommation_charbon(Variable):
    ...
    def formula(establishment, period):
        ...
        conso_combustible = establishment("consommation_charbon_combustible", period)
...
class consommation_charbon_non_combustible(Variable):
    ...
    def formula(establishment, period):
      ...
      conso_non_combustible_non_carburant = establishment("consommation_charbon_non_combustible_non_carburant", period)
...
class consommation_charbon_double_usage(Variable):
    ...
    def formula_2007_01_01(establishment, period):
        conso_double = establishment("consommation_charbon_double_usage_reductionchimique", period)
        return conso_double

    def formula_2009_01_01(establishment, period):
        conso_double = establishment("consommation_charbon_double_usage_265C", period)
        return conso_double
...
class consommation_charbon_combustible(Variable):
    ...
    def formula(establishment, period):
        ...
        conso_combustible_other = establishment("consommation_charbon_combustible_other", period)
...
class consommation_charbon_combustible_electricite(Variable):
    ...
    def formula(establishment, period):
        conso_266qA = establishment("consommation_charbon_combustible_electricite_266qA", period)
        conso_petitprod = establishment("consommation_charbon_combustible_electricite_petits_producteurs", period)
        conso_other = establishment("consommation_charbon_combustible_electricite_other", period)
