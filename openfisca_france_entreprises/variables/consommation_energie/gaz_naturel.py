...
class consommation_gaz_production_electricite_non_exonere(Variable):
    ...
    def formula_2008_01_01(etablissement, period):
        ...
        conso_non_beneficier_tarif_achat_2000_108 = etablissement("consommation_non_beneficier_tarif_achat_2000_108", period)
        return (conso_installation_266qA - conso_non_beneficier_tarif_achat_2000_108)
    def formula_2011_01_01(etablissement, period):
        ...
        return (conso_installation_266qA - conso_non_beneficier_tarif_achat_2000_108 + conso_petitprod)
...
class consommation_non_beneficier_tarif_achat_2000_108(Variable):
    value_type = float
    unit = 'MWh'
    entity = Etablissement
    label = ""
