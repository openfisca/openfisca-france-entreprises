...
class tdcfe_coefficient_multiplicateur_normal_2016(Variable):
    value_type = float 
...
class tdcfe_coefficient_multiplicateur_prof_moins_36kVA_2016(Variable):
    value_type = float 
    entity = Etablissement
    label = "le coefficient multiplicateur du département pour le tdcfe en 2012" 
    definition_period = YEAR
...
class tdcfe_coefficient_multiplicateur_prof_plus_36_moins_250kVA_2016(Variable):
    value_type = float 
    entity = Etablissement
...
class tdcfe_coefficient_multiplicateur_non_prof_moins_250kVA_2016(Variable):
    value_type = float 
    entity = Etablissement
    label = "le coefficient multiplicateur du département pour le tdcfe en 2012" #nomencultures des activités françaises
    definition_period = YEAR
